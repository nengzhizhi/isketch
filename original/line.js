    ...
    var f = function(d) {
        return function(a, e, f, l) {
            ...
            function(a) {
                ...
                a.lineCap = "round";
                a.lineJoin = "round";
                if (d) a.globalAlpha = b.opacity / 100,
                a.globalCompositeOperation = c.getComposite(b.composite),
                a.lineWidth = e,
                b.isEditing ? m.VOBPath(a, f) : m.VOBPath(a, f.slice(0, -1));
                else {
                    var l = b.bbox.scale,
                ...
                if (d) {
                    ...
                    if (g) {
                        ...
                        v = x.pointAtopStart;
                        g = x.pointOnPath;
                        if (! (g || l && (!v || eventjs.metaKey || eventjs.altKey) || !1 !== e && !1 !== k) && (l = f[d], u = l.cmd, 
                        T[u])) if (w = f[d - 1], v) T[u](a, w, l, "#46f224");
                        else T[u](a, w, l, "#4f80ff"),
                        L(a, l, "#fff", 2.5);
                        if (g) if (eventjs.metaKey) e = g.point,
                        a.save(),
                        a.beginPath(),
                        r.exmark(a, e.x, e.y, 3),
                        a.lineWidth = 2.5,
                        a.strokeStyle = "#000",
                        a.stroke(),
                        a.lineWidth = 1.5,
                        a.strokeStyle = "#46f224",
                        a.stroke(),
                        a.restore();
                        else if (!1 === e && (u = g.cmd, T[u])) T[u](a, g.point0, g.point1, "#4f80ff");
                        e = "Z" === f[d].cmd;
                        for (v = 0; v < d; v++) ! (l = f[v]) || e && v + 1 === d || (g = a, 0 !== v || e ? l.hovered ? eventjs.metaKey ? V(g, l, "#ff3535", 5) : eventjs.altKey ? V(g, l, "#bc19fc", 5) : V(g, l, "#4f80ff", 
                        5) : V(g, l, "rgba(0,0,0,0.75)", 3) : l.hovered ? eventjs.metaKey ? L(g, l, "#ff3535", 4.5) : eventjs.altKey ? L(g, l, "#bc19fc", 4.5) : L(g, l, "#46f224", 4.5) : L(g, l, "#fff", 4.5))
                    }
                }
            };
            b.calcBBox = function() {
            ...
            b.onPointerMove = function(a, c) {
                ...
                if (!d || b.adding || b.splittingSegment || b.deletingPoint) {
                    for (var e = !1, f = !1, k, p = G(), l = p.length, g = 0; g < l; g++) {
                        ...
                        r.hovered = !1;
                        v && (v.hovered = !1, h.inBBox(c, v) && (v.hovered = !0, !q || !1 !== e && "point" === e.type || (v = h.distance(r, c), 7 > v && (r.hovered = !0, e = h.clone(r), e.idx = g, e.type = "point", e.distance = v)), !1 === e && ("C" === s ? (s = h(r.x1, r.y1), v = h.distance(s, c), 7 > v && (e = s, e.idx = g, e.type = "cp1", e.distance = v), q && (q = h(r.x2, r.y2), v = h.distance(q, c), 7 > v && (e = q, e.idx = g, e.type = "cp2", e.distance = v), q = t.nearestPointOnCurve(c, [k, s, q, r]), 5 > q.distance && 
                    ...
                    d ? O("") : e ? (f = !1, "point" === e.type ? eventjs.altKey ? O("Alter Tension") : eventjs.metaKey ? O("Remove Point") : eventjs.shiftKey ? O("Move Point w/o Handles") : 0 === e.idx ? O("Close Path") : O("Move Point") : eventjs.altKey ? O("Move Handle Mirrored") : 
                    eventjs.metaKey ? O("Remove Handle") : O("Move Handle")) : f ? eventjs.metaKey ? O("Add Point") : eventjs.altKey ? "C" === f.cmd ? O("Move Curve") : O("Move Line") : "C" === f.cmd ? O("Bend Curve") : O("Bend Line") : (r = p[l - 1], k = p[l - 2], r && k ? (v = h.distance(r, k), O("D: " + v.toFixed(2) + "px")) : O(""));
                    x.pointAtop = e;
            ...
            b.onPointer = function(a, c, d) {
                ...
                var p = c.length;
                b.ghostPoint = void 0;
                if (a.pointerStart) if (O(""), 
                b.selected = void 0, b.adding = !1, b.bendingSegment = !1, b.closingPath = !1, b.convertingPoint = !1, b.deletingPoint = !1, b.editingPath = !0, b.movingPoint = !1, b.movingPointLocked = !1, b.movingSegment = !1, b.splittingSegment = !1, 0 === p) A(d, "M"),
                A(d, "L"),
                b.adding = !0,
                b.selected = {
                    idx: 0,
                ...
                J();
                    ...
                    if (eventjs.metaKey) if (b.deletingPoint = !0, b.selected = e, d = e.idx, c = e.type, "point" === c) {
                        m = G();
                        c = m[d];
                        if (m = m[d + 1])"M" === c.cmd ? F(m, "M") : "C" === m.cmd && (m.x1 = c.x1, m.y1 = c.y1),
                        m.bbox = void 0;
                        P(d, 1)
                    } else a = G(),
                    m = a[d - 1],
                    e = a[d],
                    d = a[d + 1],
                    "cp1" === c ? (e.x1 = m.x, e.y1 = m.y, m.angleLock = e.x1 === m.x2 && e.y1 === m.y2) : (e.x2 = e.x, e.y2 = e.y, e.angleLock = e.x2 === d.x1 && e.y2 === d.y1),
                    C(e, m),
                    e.bbox = void 0;
                    ...
                    if (!b.deletingPoint && 
                    !b.splittingSegment) if (b.movingPoint || b.movingPointLocked) m = b.selected,
                    e = m.type,
                    m = m.idx,
                    a = c[m],
                    f = c[m + 1],
                    c = c[m - 1],
                    "point" === e ? (c = a.x - d.x, d = a.y - d.y, b.movingPoint ? (m = G()[m], m.x -= c, m.y -= d, m.angleLock = !1, m.bbox = void 0) : y(m, c, d)) : "cp1" === e ? B(a, f, c, d, "x1", "y1") : "cp2" === e && B(a, f, c, d, "x2", "y2");
                    else if (b.movingSegment) c = b.movingSegment,
                    m = c.idx,
                    a = c.point,
                    e = a.x - d.x,
                    a = a.y - d.y,
            ...
            b.onBackspaceKey = b.onDeleteKey = function(a) {
                if ("down" === a.state) if (2 < (b.path || []).length) P( - 1, 1),
                E(b.point),
                N();
                else return K(),
                !0
